...
import dev.fede.zenithgui.client.screens.menu.settings.impl.popup.MenuItemPopupSetting;
...
public class MenuItemSetting extends MenuSetting {
    ...
    public void onMouseClicked(double mouseX, double mouseY, MouseButton button) {
        if (this.bounds != null && this.bounds.contains(mouseX, mouseY)) {
            FeClientBridge.getInstance().getMenuScreen().addPopupMenuSetting(new MenuItemPopupSetting(this.setting, this.boundsColor));
        }
    }
