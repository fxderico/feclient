...
public interface Easing {
    ...
    Easing SMOOTH_STEP = (t, b, c, d) -> {
        float x = c * t / d + b;
        return (float)(-2.0 * Math.pow((double)x, 3.0) + 3.0 * Math.pow((double)x, 2.0));
    };
    Easing BOTH_CUBIC = (t, b, c, d) -> {
        float x = c * t / d + b;
        return (double)x < 0.5 ? 4.0F * x * x * x : (float)(1.0 - Math.pow((double)(-2.0F * x + 2.0F), 3.0) / 2.0);
    };
    ...
    Easing SINE_IN = (t, b, c, d) -> -c * (float)MathUtil.cos((double)(t / d) * (Math.PI / 2)) + c + b;
    Easing SINE_OUT = (t, b, c, d) -> c * (float)MathUtil.sin((double)(t / d) * (Math.PI / 2)) + b;
    Easing SINE_IN_OUT = (t, b, c, d) -> -c / 2.0F * ((float)MathUtil.cos(Math.PI * (double)t / (double)d) - 1.0F) + b;
    ...
    public static class ElasticIn extends Easing.Elastic {
        ...
        public float ease(float t, float b, float c, float d) {
            ...
            if (t == 0.0F) {
                ...
                return -(a * (float)Math.pow(2.0, (double)(10.0F * --t)) * (float)MathUtil.sin((double)(t * d - s) * (Math.PI * 2) / (double)p)) + b;
            }
        }
    }
    ...
    public static class ElasticInOut extends Easing.Elastic {
        ...
        public float ease(float t, float b, float c, float d) {
            ...
            if (t == 0.0F) {
                ...
                return t < 1.0F
                    ? -0.5F * a * (float)Math.pow(2.0, (double)(10.0F * --t)) * (float)MathUtil.sin((double)(t * d - s) * (Math.PI * 2) / (double)p) + b
                    : a * (float)Math.pow(2.0, (double)(-10.0F * --t)) * (float)MathUtil.sin((double)(t * d - s) * (Math.PI * 2) / (double)p) * 0.5F + c + b;
            }
        }
    }
    ...
    public static class ElasticOut extends Easing.Elastic {
        ...
        public float ease(float t, float b, float c, float d) {
            ...
            if (t == 0.0F) {
                ...
                return a * (float)Math.pow(2.0, (double)(-10.0F * t)) * (float)MathUtil.sin((double)(t * d - s) * (Math.PI * 2) / (double)p) + c + b;
            }
        }
    }
}
