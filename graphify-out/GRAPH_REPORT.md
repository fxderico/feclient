...
## Corpus Check
- 584 files · ~351,782 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 6550 nodes · 19179 edges · 245 communities (174 shown, 71 thin omitted)
- Extraction: 94% EXTRACTED · 6% INFERRED · 0% AMBIGUOUS · INFERRED: 1229 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `3bb72a80`
...
1. `Module` - 314 edges
2. `NumberSetting` - 237 edges
3. `BooleanSetting` - 229 edges
4. `NVGRenderer` - 201 edges
5. `Module` - 174 edges
6. `Setting` - 159 edges
7. `Category` - 155 edges
...
Cohesion: 0.06
Nodes (26): net.minecraft.client.input.Input, net.minecraft.client.input.KeyboardInput, net.minecraft.network.packet.s2c.play.BlockBreakingProgressS2CPacket, net.minecraft.network.packet.s2c.play.BlockEntityUpdateS2CPacket, net.minecraft.network.packet.s2c.play.BlockUpdateS2CPacket, net.minecraft.network.packet.s2c.play.ChunkDeltaUpdateS2CPacket, net.minecraft.network.packet.s2c.play.EntityPositionS2CPacket, net.minecraft.network.packet.s2c.play.EntityPositionSyncS2CPacket (+18 more)
...
Cohesion: 0.09
Nodes (10): getRtpBaseFinderSweepLegArray(), Inner1, BlockPos, Override, Vec3d, RtpBaseFinder, SweepLeg, LATERAL (+2 more)
...
### Community 10 - "PotionsHud"
Cohesion: 0.50
Nodes (3): net.minecraft.entity.effect.StatusEffectInstance, Override, PotionsHud

### Community 11 - "Setting"
Cohesion: 0.05
Nodes (24): net.fabricmc.fabric.api.networking.v1.PacketSender, net.minecraft.client.gui.screen.ingame.InventoryScreen, net.minecraft.entity.projectile.thrown.EnderPearlEntity, net.minecraft.sound.SoundCategory, net.minecraft.util.hit.HitResult, net.minecraft.world.chunk.ChunkSection, SmartCullAccessor, Category (+16 more)

### Community 12 - "HudManager"
Cohesion: 0.05
Nodes (6): net.minecraft.client.input.MouseInput, HudDragController, HudManager, JsonObject, Placement, NVGImages
...
Cohesion: 0.15
Nodes (12): com.mojang.blaze3d.buffers.GpuBufferSlice, net.minecraft.client.render.Camera, net.minecraft.client.render.WorldRenderer, net.minecraft.client.util.memory.ObjectAllocator, org.joml.Vector4f, org.spongepowered.asm.mixin.Shadow, CameraFreecamMixin, FreelookCameraClipMixin (+4 more)

### Community 16 - "net.minecraft.client.network.ClientPlayNetworkHandler"
Cohesion: 0.06
Nodes (19): net.minecraft.client.network.ClientPlayNetworkHandler, net.minecraft.client.world.ClientChunkManager, net.minecraft.network.packet.s2c.play.ChunkDataS2CPacket, net.minecraft.network.packet.s2c.play.EntityStatusS2CPacket, net.minecraft.network.packet.s2c.play.EntityVelocityUpdateS2CPacket, net.minecraft.network.packet.s2c.play.ExplosionS2CPacket, net.minecraft.network.packet.s2c.play.GameMessageS2CPacket, net.minecraft.network.packet.s2c.play.LightUpdateS2CPacket (+11 more)

### Community 17 - "AutoTunnel"
Cohesion: 0.10
Nodes (3): AutoTunnel, Override, AutoTunnelUtil3

### Community 18 - "org.spongepowered.asm.mixin.Mixin"
Cohesion: 0.06
Nodes (19): net.minecraft.client.gui.hud.bar.ExperienceBar, net.minecraft.client.gui.hud.ChatHud, net.minecraft.client.network.ClientCommonNetworkHandler, net.minecraft.client.network.PendingUpdateManager, net.minecraft.entity.projectile.ProjectileUtil, org.spongepowered.asm.mixin.gen.Invoker, org.spongepowered.asm.mixin.injection.ModifyVariable, org.spongepowered.asm.mixin.Mixin (+11 more)

### Community 19 - "net.minecraft.util.math.Vec3d"
Cohesion: 0.10
Nodes (15): net.minecraft.client.render.state.WorldRenderState, net.minecraft.client.render.VertexConsumerProvider.Immediate, net.minecraft.client.util.math.MatrixStack, net.minecraft.util.math.Vec3d, LevelRendererMixin, BlockPos, Inner11, Inner12 (+7 more)
...
Cohesion: 0.19
Nodes (3): net.minecraft.block.entity.BlockEntityType, BlockEntityEspModule, Override

### Community 23 - ".renderNvg"
Cohesion: 0.08
Nodes (7): IconPickerScreen, Override, Layout, IconListGridModel, Cell, PickerGrid, IconListSetting
...
Cohesion: 0.05
Nodes (16): ConfigStore, ImportResult, JsonObject, Slot, ConfigSystemGameTest, Action, ACTIVATE, DELETE (+8 more)

### Community 27 - "AuthGate"
Cohesion: 0.10
Nodes (4): AuthGate, TriggerBot, Chams, AntiDebugUtil

### Community 28 - "SeedCaveXrayRenderer"
Cohesion: 0.10
Nodes (8): net.minecraft.world.gen.chunk.ChunkGenerator, net.minecraft.world.gen.noise.NoiseConfig, Override, BlockEspRenderer, Hit, ChunkScanner, IncrementalScan, SeedCaveXrayRenderer
...
### Community 33 - "Module"
Cohesion: 0.04
Nodes (19): ChatMacroModule, Override, StringSetting, CoordSnapperModule, Override, CriticalsModule, Override, ElytraSwapModule (+11 more)

### Community 34 - "ThemeManager"
Cohesion: 0.03
Nodes (36): java.util.function.BooleanSupplier, org.lwjgl.nanovg.NVGColor, org.lwjgl.system.MemoryStack, BlockListWidget, Override, BooleanWidget, Override, IconListWidget (+28 more)
...
Cohesion: 0.10
Nodes (11): net.minecraft.scoreboard.Scoreboard, net.minecraft.scoreboard.Team, net.minecraft.world.dimension.DimensionType, org.spongepowered.asm.mixin.injection.callback.CallbackInfoReturnable, EntityFreecamMixin, FullbrightCurveMixin, ScoreboardTeamSpamMixin, XRayBlockCullMixin (+3 more)
...
Cohesion: 0.09
Nodes (10): net.minecraft.block.BlockState, net.minecraft.registry.RegistryKey, AntiTrapModule, Override, BedESPModule, Override, BlockPos, Mutable (+2 more)

### Community 40 - "HitboxesModule"
Cohesion: 0.23
Nodes (3): HitboxEntityMixin, HitboxesModule, Override

### Community 41 - "OutlineESPModule"
Cohesion: 0.16
Nodes (3): GlowTeamColorMixin, Override, OutlineESPModule
...
Cohesion: 0.06
Nodes (14): net.minecraft.entity.decoration.EndCrystalEntity, net.minecraft.item.Item, net.minecraft.util.Hand, net.minecraft.util.hit.BlockHitResult, AutoCrystalModule, Override, Override, MaceSwapModule (+6 more)

### Community 45 - "net.minecraft.client.render.RenderLayer"
Cohesion: 0.13
Nodes (10): net.minecraft.client.render.entity.LivingEntityRenderer, net.minecraft.client.render.entity.state.LivingEntityRenderState, net.minecraft.client.render.RenderLayer, ChamsLivingEntityRendererMixin, Inner10, Inner13, Inner5, Inner6 (+2 more)
...
Cohesion: 0.06
Nodes (14): com.google.gson.JsonElement, com.google.gson.JsonPrimitive, java.net.http.HttpClient, Override, SkinProtectModule, Override, ViewModule, Override (+6 more)

### Community 56 - "Inner1"
Cohesion: 0.22
Nodes (3): Inner1, Vec3d, MinerMovementHelper

### Community 58 - "AutoClickerModule"
Cohesion: 0.07
Nodes (9): OptionInstanceAccessor, Override, TabGUIModule, AutoClickerModule, Override, FullbrightModule, Override, Override (+1 more)
...
Cohesion: 0.14
Nodes (6): net.minecraft.client.texture.NativeImageBackedTexture, net.minecraft.resource.ResourceManager, Override, GlintTextureReplacer, NativeImage, NativeImageBackedTexture
...
Cohesion: 0.14
Nodes (9): net.minecraft.client.render.WeatherRendering, net.minecraft.sound.SoundEvent, net.minecraft.world.biome.Biome.Precipitation, net.minecraft.world.World, UiSoundEvents, ClientWorldMixin, WeatherRenderingMixin, WorldMixin (+1 more)

### Community 65 - "Chest"
Cohesion: 0.08
Nodes (10): NbtCompound, net.minecraft.nbt.NbtCompound, ContainerSnapshotMixin, Override, Chest, Box, ContainerSnapshotMixinEntry, ItemStack (+2 more)
...
Cohesion: 0.17
Nodes (3): Override, Override, VelocityModule
...
Cohesion: 0.07
Nodes (6): Hitbox, HomeSetter, Override, NameProtect, Setting, ToggleableIntegerSetting
...
Cohesion: 0.12
Nodes (8): net.minecraft.client.render.VertexConsumer, net.minecraft.client.util.math.MatrixStack.Entry, org.joml.Vector3f, HitParticle, AccessoryRenderer, Vector3f, HitParticleRenderer, Vector3f

### Community 79 - ".render"
Cohesion: 0.08
Nodes (5): Override, SpotifyHud, SpotifyService, SpotifyState, Override

### Community 80 - "FakeStatsModule"
Cohesion: 0.10
Nodes (4): FakePayModule, FakeStatsModule, Override, Amounts
...
Cohesion: 0.15
Nodes (6): net.minecraft.client.Mouse, MouseHandlerFreecamMixin, InventoryMoveKeyBindingMixin, InventoryMoveMouseMixin, InventoryMoveModule, Override

### Community 84 - "MinerMovementHelper.java"
Cohesion: 0.14
Nodes (13): getMinerMovementHelperPhaseArray(), getMinerMovementHelperScaffoldResultArray(), getMinerMovementHelperTorchResultArray(), ScaffoldResult, ABORTED, IN_PROGRESS, PLACED, TIMED_OUT (+5 more)
...
### Community 87 - ".getValue"
Cohesion: 0.09
Nodes (6): Override, Override, Override, Override, Override, Override
...
Cohesion: 0.07
Nodes (9): InventoryScreen, AutoTotemModule, Override, ConfigsModule, Override, Override, MiddleClickModule, JsonObject (+1 more)

### Community 93 - "HoleEspRenderer"
Cohesion: 0.15
Nodes (5): net.minecraft.util.math.BlockPos.Mutable, Override, Hole, HoleEspRenderer, Mutable
...
Cohesion: 0.07
Nodes (22): net.minecraft.client.font.TextRenderer, net.minecraft.client.font.TextRenderer.TextLayerType, net.minecraft.client.gui.hud.InGameHud, net.minecraft.client.gui.hud.PlayerListHud, net.minecraft.client.network.PlayerListEntry, net.minecraft.client.render.command.LabelCommandRenderer, net.minecraft.client.render.VertexConsumerProvider, net.minecraft.scoreboard.ScoreboardObjective (+14 more)

### Community 96 - "net.minecraft.world.chunk.WorldChunk"
Cohesion: 0.18
Nodes (3): net.minecraft.world.chunk.WorldChunk, BlockPos, BlockPos
...
### Community 102 - "com.google.gson.JsonObject"
Cohesion: 0.05
Nodes (12): com.google.gson.JsonObject, ConfigManager, JsonObject, Section, ModuleManager, Override, Override, Setting (+4 more)

### Community 103 - "StorageESPModule"
Cohesion: 0.13
Nodes (3): Override, StorageESPModule, ClientPlayNetworkHandlerMixinUtil

### Community 104 - "CornerBoxESPModule.java"
Cohesion: 0.22
...
Cohesion: 0.07
Nodes (8): AutoCrystalGameTest, BlockPos, Box, Override, ThemesPanel, ColorWidget, Override, Override
...
Cohesion: 0.15
Nodes (12): ArmorTrim, net.minecraft.client.render.entity.equipment.EquipmentRenderer, net.minecraft.entity.attribute.EntityAttributeModifier, net.minecraft.item.equipment.trim.ArmorTrim, net.minecraft.item.equipment.trim.ArmorTrimMaterial, net.minecraft.item.equipment.trim.ArmorTrimPattern, net.minecraft.registry.DynamicRegistryManager, net.minecraft.registry.entry.RegistryEntry (+4 more)
...
Cohesion: 0.33
Nodes (3): AlbumArtCache, NativeImage, NativeImageBackedTexture

### Community 137 - "RegionMapModule"
Cohesion: 0.13
Nodes (4): RegionMapGameTest, Override, RegionMapHud, RegionMapModule
...
### Community 144 - "ViewModelModule"
Cohesion: 0.10
Nodes (8): net.minecraft.client.network.AbstractClientPlayerEntity, net.minecraft.client.render.item.HeldItemRenderer, net.minecraft.entity.player.SkinTextures, AbstractClientPlayerMixin, ViewModelMixin, Override, ViewModelModule, HeldItemRendererMixin

### Community 145 - "AutoCrystalModule"
Cohesion: 0.15
Nodes (4): AutoCrystalModule, Override, Vec3d, Override

### Community 149 - "SpectatorDetectorModule"
Cohesion: 0.22
...
### Community 154 - ".run15"
Cohesion: 0.08
Nodes (4): Vec3d, Inner4, Inner7, Inner8
...
### Community 168 - "Phase"
Cohesion: 0.29
Nodes (6): Phase, DONE, PLACE, RELEASE, ROTATE_SNEAK, SWAP
...
Cohesion: 0.11
Nodes (10): net.minecraft.util.math.Vec2f, net.minecraft.util.PlayerInput, net.minecraft.world.chunk.ChunkNibbleArray, org.spongepowered.asm.mixin.gen.Accessor, ClientInputAccessor, ChunkNibbleArrayAccessor, MinecraftClientAccessor, Override (+2 more)

### Community 180 - "PearlAlertModule"
Cohesion: 0.31
Nodes (3): Override, Vec3d, PearlAlertModule

### Community 182 - "net.minecraft.util.Identifier"
Cohesion: 0.11
Nodes (7): net.minecraft.util.Identifier, HUDModuleData, InternalUtil, AutoDropModule, Override, FastUseModule, Override

### Community 184 - "java.lang.reflect.Field"
Cohesion: 0.20
...
### Community 190 - "ViewCoordsCommand"
Cohesion: 0.33
...
Cohesion: 0.24
Nodes (3): Inner1, Inner2, PathUtils_2
...
Cohesion: 0.04
Nodes (26): LivingEntityAccessor, ChromaXPModule, ClickSounds, AirJumpModule, Override, FastStairsModule, Override, HighJumpModule (+18 more)

### Community 215 - "StringSetting"
Cohesion: 0.10
Nodes (6): net.minecraft.entity.player.PlayerInventory, ItemDropperModule, Override, NicknameModule, AutoStoreModule, StringSetting

### Community 222 - "ChunkFinderModule"
Cohesion: 0.11
Nodes (6): net.minecraft.util.math.ChunkPos, AutoTpaModule, Override, ChunkFinderModule, ChunkPos, Override
...
### Community 229 - "BlockOutlineRenderer.java"
Cohesion: 0.36
...
Cohesion: 0.07
Nodes (16): net.minecraft.entity.LivingEntity, MovementSpeedMixin, SwingDurationMixin, ChestStealerModule, MaceAuraModule, NoFallModule, ThreadLocalRandom, SpeedModule (+8 more)
...
- **Why does `Module` connect `Module` to `net.minecraft.client.world.ClientWorld`, `AutoLogModule`, `.getValueInt`, `KillAura`, `Setting`, `AutoTunnel`, `CodeEngineScreenUtil`, `AuthGate`, `net.minecraft.client.MinecraftClient`, `net.minecraft.block.BlockState`, `HitboxesModule`, `OutlineESPModule`, `HUDModule`, `AutoSell`, `AutoTunnel.java`, `NukerModule`, `AutoClickerModule`, `net.minecraft.item.ItemStack`, `ClearWorldModule`, `StashFinder`, `EntityNameTagMixin.java`, `RegionMap`, `NametagsModule`, `VelocityModule`, `TargetHUDModule`, `PortalESP`, `InventoryMoveModule`, `AutoTreeModule`, `SpawnerESPModule`, `Manager`, `SeedChunkFinder`, `AutoTotemModule`, `ServerLightCache`, `InfoOrb`, `ChunkSpoof`, `StorageESPModule`, `CornerBoxESPModule.java`, `RaidPlannerModule`, `AutoMLGModule`, `HoleESPModule`, `AutoArmor`, `AutoFish`, `net.minecraft.client.network.ClientPlayerEntity`, `net.minecraft.entity.Entity`, `ScaffoldModule`, `HeatMapChunkRadarModule`, `AntiVoidModule`, `CriticalsModule`, `XRay`, `ViewModelModule`, `AutoCrystalModule`, `AutoEatModule`, `AutoWalkModule`, `KeystrokeHUDModule`, `SpectatorDetectorModule`, `NoSlowModule`, `ThemeSelectorModule`, `RPCModule`, `CustomTitleModule`, `AntiAFKModule`, `ItemESPModule`, `LightDebugModule`, `CauldronESPModule`, `LongJumpModule`, `MovementTrailsModule`, `net.minecraft.client.gui.DrawContext`, `NetheriteFinderModule`, `AutoToolModule`, `PearlAlertModule`, `LightFinderModule`, `net.minecraft.util.Identifier`, `FreecamModule`, `PrimeChunkFinderModule`, `ModeSetting`, `ColorSetting`, `AutoSpawnerSellModule`, `imgui.ImDrawList`, `EagleAuraModule`, `TimerSpeedModule`, `SpawnerProtectModule`, `com.llamalad7.mixinextras.injector.ModifyReturnValue`, `nyx/module/ModuleManager.java`, `StringSetting`, `BlockGlowModule`, `TracersModule`, `ChatFilterHelper`, `CodeEngineScreen`, `BacktrackModule`, `NumberSetting`?**
  _High betweenness centrality (0.114) - this node is a cross-community bridge._
- **Why does `NVGRenderer` connect `NVGRenderer` to `net.minecraft.util.math.Box`, `ThemeManager`, `org.joml.Matrix4f`, `StaffEntry`, `RegionMapModule`, `PotionsHud`, `NotificationManager`, `HudManager`, `CategoryPanel`, `ModuleManager`, `ColorWidget`, `FeClient.java`, `Panel`, `.render`, `BooleanSetting`, `StringWidget`, `.renderNvg`?**
  _High betweenness centrality (0.061) - this node is a cross-community bridge._
- **Why does `Module` connect `Module` to `NameProtectModule`, `NyxModuleBridge`, `ShieldBreakerModule`, `NVGRenderer`, `RegionMapModule`, `XRayModule`, `ModuleManager`, `BlockEntityEspModule`, `FreeLookModule`, `net.minecraft.client.MinecraftClient`, `AimAssistModule`, `ThemeManager`, `.getFloat`, `SpawnerNametagsModule`, `net.minecraft.item.Item`, `FreecamModule`, `FeClient.java`, `Panel`, `SpawnerProtectModule`, `StringSetting`, `PhaseModule`, `BooleanSetting`, `FakeStatsModule`, `ChunkFinderModule`, `net.minecraft.text.Text`, `com.google.gson.JsonObject`, `ArmorTrimHiderModule`, `GambleRiggerModule`, `DoubleAnchorModule`?**
